/**
 * Default max number of cached proxy dispatchers.
 */
 ...
 */
export class BoundedDispatcherCache<K, V> {
  ...
  /**
   * Clears the cache and evicts values.
   */
  clear(): void {
  ...
  /**
   * Gets a value and refreshes recency.
   *
   * @param key Cache key.
